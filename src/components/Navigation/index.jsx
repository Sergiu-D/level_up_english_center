                    ...
                    <NavigationMenuItem key={`${link.path}-${linkIndex}`}>
                      {link.subLinks ? (
                        <>
                          ...
                          <NavigationMenuContent>
                            <div className="grid gap-3 grid-rows-[1fr_1fr] p-6 lg:grid-cols-[3fr_1fr_1fr_1fr]">
                        ...
                        <Link href={link.path} legacyBehavior passHref>
                          <NavigationMenuLink className=" text-white font-medium hover:bg-transparent">
                            {link.label}
                          </NavigationMenuLink>
                        </Link>
                      )}
              ...
              {navigationLinks.map((link, linkIndex) => (
                ...
                >
                  {link.subLinks ? (
                        ...
                        <div className="pl-4 space-y-2">
                          {link.subLinks.map((subLink, subLinkIndex) => (
                            ...
                            >
                              <Link
                                href={subLink.path}
                                className="text-white hover:bg-transparent block px-3 py-2 rounded-md text-sm font-medium"
                              >
                                {subLink.label}
                              </Link>
                    ...
                    <Link
                      href={link.path}
                      className="text-white hover:bg-transparent block px-3 py-2 text-base font-medium"
                    >
                      {link.label}
                    </Link>
                  )}
