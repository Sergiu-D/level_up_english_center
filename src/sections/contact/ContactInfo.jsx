...
export default function ContactInfo() {
  // Create ref for animated element
  ...
  useEffect(() => {
    ...
    if (contentRef.current) {
      inView(contentRef.current, () => {
        animate(contentRef.current, { opacity: [0, 1], x: [20, 0] }, { duration: 0.6 });
        return () => {};
      });
    }
  }, []);
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div
          ref={contentRef}
          className="max-w-xl mx-auto md:mx-0 md:mr-auto opacity-0"
        >
          <h2 className="text-3xl font-bold mb-8">
            Informații de <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">contact</span>
          </h2>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">Răspundem în maxim 24 de ore</p>
                <Link 
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">Luni-Vineri: 9:00 - 18:00</p>
                <Link 
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">Vizitează-ne la sediul nostru</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">Orele noastre de funcționare</p>
